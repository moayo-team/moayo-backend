...
public class ProfileIndexItem extends BaseEntity {
    ...
    @Column(name="index_value", nullable = false, length = 20)
    ...
    @Column(name="text_value", length = 10)
    private String textValue;

    @Column(name="link_url", length = 500)
    private String linkUrl;

    public ProfileIndexItem(Long profileId, String indexKey, String indexValue, ItemType itemType, String textValue, String linkUrl) {
    ...
    public void update(String indexKey, String indexValue, String textValue, String linkUrl) {
